...
declare -A FILE_MAP=(
  ...
  ["guide-examples-streams"]="guide/examples-streams 3"
  ["guide-conventions"]="guide/conventions 4"
  ["guide-troubleshooting"]="guide/troubleshooting 6"
  ["cookbook"]="guide/cookbook 5"
  # guide-make promoted to /make (standalone page outside docs tree)
  ["topic-types"]="language/types 1"
  ["topic-type-system"]="language/type-system 7"
  ...
  ["topic-error-handling"]="language/error-handling 10"
  ["topic-collections"]="data/collections 1"
  ["topic-collection-slicing"]="data/collection-slicing 2"
  ["topic-iterators"]="data/iterators 3"
  ["topic-strings"]="data/strings 4"
  ["integration-host"]="integration/host 1"
  ["integration-resolvers"]="integration/resolvers 2"
  ...
  ["ref-language-service"]="reference/language-service 7"
...
declare -A LINK_MAP=(
  ...
  ["guide-examples-streams.md"]="/docs/guide/examples-streams/"
  ...
  ["topic-error-handling.md"]="/docs/language/error-handling/"
  ["topic-collections.md"]="/docs/data/collections/"
  ["topic-collection-slicing.md"]="/docs/data/collection-slicing/"
  ["topic-iterators.md"]="/docs/data/iterators/"
  ["topic-strings.md"]="/docs/data/strings/"
  ["integration-host.md"]="/docs/integration/host/"
  ["integration-resolvers.md"]="/docs/integration/resolvers/"
  ...
  ["ref-language-service.md"]="/docs/reference/language-service/"
