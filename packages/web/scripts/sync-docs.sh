...
declare -A FILE_MAP=(
  ...
  ["integration-agent-host"]="integration/agent-host 2"
  ...
  ["integration-compose"]="integration/compose 6"
  ["integration-backends"]="integration/backends 7"
  ["integration-state-backends"]="integration/state-backends 8"
...
declare -A LINK_MAP=(
  ...
  ["integration-agent-host.md"]="/docs/integration/agent-host/"
  ...
  ["integration-compose.md"]="/docs/integration/compose/"
  ["integration-backends.md"]="/docs/integration/backends/"
  ["integration-state-backends.md"]="/docs/integration/state-backends/"
