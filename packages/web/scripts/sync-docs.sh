...
declare -A SECTION_MAP=(
  ...
  ["agent"]="Agent|Agent packages for rill — harness, bundle, run, shared|4.5"
...
declare -A FILE_MAP=(
  ...
  ["integration-extensions"]="integration/extensions 3"
  ["integration-modules"]="integration/modules 4"
  ["integration-cli"]="integration/cli 5"
  ["integration-backends"]="integration/backends 7"
  ["agent-harness"]="agent/harness 1"
  ["agent-bundle"]="agent/bundle 2"
  ["agent-run"]="agent/run 3"
  ["agent-shared"]="agent/shared 4"
  ["agent-build"]="agent/build 5"
  ["agent-proxy"]="agent/proxy 6"
  ["extension-llm-anthropic"]="extensions/llm-anthropic 1"
  ["extension-vectordb-chroma"]="extensions/vectordb-chroma 2"
  ["extension-claude-code"]="extensions/claude-code 3"
  ["extension-llm-gemini"]="extensions/llm-gemini 4"
  ["extension-llm-openai"]="extensions/llm-openai 5"
  ["extension-vectordb-pinecone"]="extensions/vectordb-pinecone 6"
  ["extension-vectordb-qdrant"]="extensions/vectordb-qdrant 7"
  ["extension-mcp"]="extensions/mcp 8"
  ["extension-kv-sqlite"]="extensions/kv-sqlite 9"
  ["extension-kv-redis"]="extensions/kv-redis 10"
  ["extension-fs-s3"]="extensions/fs-s3 11"
...
declare -A LINK_MAP=(
  ...
  ["integration-backends.md"]="/docs/integration/backends/"
  ["agent-harness.md"]="/docs/agent/harness/"
  ["agent-bundle.md"]="/docs/agent/bundle/"
  ["agent-run.md"]="/docs/agent/run/"
  ["agent-shared.md"]="/docs/agent/shared/"
  ["agent-build.md"]="/docs/agent/build/"
  ["agent-proxy.md"]="/docs/agent/proxy/"
  ["bundled-extensions.md"]="/docs/extensions/"
  ["extension-llm-anthropic.md"]="/docs/extensions/llm-anthropic/"
  ["extension-vectordb-chroma.md"]="/docs/extensions/vectordb-chroma/"
  ["extension-claude-code.md"]="/docs/extensions/claude-code/"
  ["extension-llm-gemini.md"]="/docs/extensions/llm-gemini/"
  ["extension-llm-openai.md"]="/docs/extensions/llm-openai/"
  ["extension-vectordb-pinecone.md"]="/docs/extensions/vectordb-pinecone/"
  ["extension-vectordb-qdrant.md"]="/docs/extensions/vectordb-qdrant/"
  ["extension-mcp.md"]="/docs/extensions/mcp/"
  ["extension-kv-sqlite.md"]="/docs/extensions/kv-sqlite/"
  ["extension-kv-redis.md"]="/docs/extensions/kv-redis/"
  ["extension-fs-s3.md"]="/docs/extensions/fs-s3/"
