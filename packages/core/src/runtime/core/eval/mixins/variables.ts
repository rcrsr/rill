...
>(Base: TBase) {
  return class VariablesEvaluator extends Base {
    ...
    evaluateVariable(node: VariableNode): RillValue {
      return evaluateVariable(this as unknown as EvalState, node);
    }

    evaluateVariableAsync(node: VariableNode): Promise<RillValue> {
      return evaluateVariableAsync(this as unknown as EvalState, node);
    }

    evaluateFieldAccessVariable(
      access: {
        readonly kind: 'variable';
        readonly variableName: string | null;
      },
      ...
      return evaluateFieldAccessVariable(
        this as unknown as EvalState,
        access,
        value,
        node
    ...
    evaluateFieldAccessComputed(
      ...
      return evaluateFieldAccessComputed(
        this as unknown as EvalState,
        access,
        value,
        node
    ...
    evaluateFieldAccessAlternatives(
      access: {
        readonly kind: 'alternatives';
        readonly alternatives: string[];
      },
      ...
      return evaluateFieldAccessAlternatives(
        this as unknown as EvalState,
        access,
        value,
        node
    ...
    evaluateCapture(node: CaptureNode, input: RillValue): Promise<RillValue> {
      return evaluateCapture(this as unknown as EvalState, node, input);
    }

    /**
     * This overrides the stub in EvaluatorBase.
     */
    override handleCapture(
      capture: CaptureNode | null,
      value: RillValue
    ): Promise<{ name: string; value: RillValue } | undefined> {
