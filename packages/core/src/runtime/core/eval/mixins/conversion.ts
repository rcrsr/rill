...
>(Base: TBase) {
  return class ConversionEvaluator extends Base {
    ...
    applyConstructorConversion(
      ...
      return applyConstructorConversion(
     ...
     * - Extra keys not in signature: omitted from result
     */
    convertToOrderedWithSig(
      input: RillValue,
      sigNode: TypeConstructorNode,
      node: ASTNode
    ): Promise<RillValue> {
      return convertToOrderedWithSig(
        this as unknown as EvalState,
        input,
        sigNode,
        node
     ...
     * - Recurses into nested dict-typed fields for nested hydration
     */
    convertToDictWithSig(
      input: RillValue,
      sigNode: TypeConstructorNode,
      node: ASTNode
    ): Promise<RillValue> {
      return convertToDictWithSig(
        this as unknown as EvalState,
        input,
        sigNode,
        node
     ...
     * - Extra elements beyond signature length: omitted from result
     */
    convertToTupleWithSig(
      input: RillValue,
      sigNode: TypeConstructorNode,
      node: ASTNode
    ): Promise<RillValue> {
      return convertToTupleWithSig(
        this as unknown as EvalState,
        input,
        sigNode,
        node
