...
function tupleEquals(a, b) {
    ...
    for (let i = 0; i < a.elements.length; i++) {
        ...
        if (!astEquals(elemA, elemB))
            return false;
    }
    return true;
}
function listSpreadEquals(a, b) {
    return expressionEquals(a.expression, b.expression);
}
function dictEquals(a, b) {
    ...
    if (!nullableEquals(a.defaultValue, b.defaultValue))
        return false;
    return true;
}
