...
| [Language Service API](ref-language-service.md) | Outline, semantic tokens, formatting, scope, hover, go-to-definition, completion, 42-rule checker |
