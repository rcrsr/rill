...
- **AST traversal primitives:** `walkAst` and `nodeAtPosition` give language-service tooling a way to walk parsed scripts and resolve source offsets to nodes, for linters, analyzers, and codegen.
