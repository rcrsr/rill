...
- **Doc and config drift fixes:** Error reference corrected to include RILL-P023, CLI documentation's lint-rule table restored BARE_CALLABLE_BODY and corrected rule count to 42, and vitest.config.ts removed __dirname to suppress Vite configuration warnings. ([#446](https://github.com/rcrsr/rill/pull/446))
