...
- **Reserved-word member access:** Reserved words now parse as member names after a dot, so member access like `$app.error()` works correctly. ([#136](https://github.com/rcrsr/rill/pull/136))
