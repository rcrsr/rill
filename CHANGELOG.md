...
- **Core defect fixes:** Invalid regex patterns in string methods now halt with catchable #INVALID_INPUT instead of silently returning wrong data. Injected timezone, clock, and scheduler now consistently apply in nested bodies. ([#247](https://github.com/rcrsr/rill/pull/247))
