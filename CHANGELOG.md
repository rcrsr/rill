...
- **Postfix bracket-index access:** Bracket-index access `[i]` after literals, expressions, or calls now works as postfix indexing. ([#408](https://github.com/rcrsr/rill/pull/408))
