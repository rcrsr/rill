...
- **Fiddle and docs correctness:** Ctrl/Cmd+Enter executes scripts, Web Worker timeout prevents runaway hangs, syntax highlighter and output panel fixed, atom literal documentation corrected. ([#335](https://github.com/rcrsr/rill/pull/335))
